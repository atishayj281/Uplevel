 ...
 * Use the [BookmarkedJobFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class BookmarkedJobFragment : Fragment(), JobItemClicked, onJobSearch {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_bookmarked_job, container, false)
    ...
    private fun setUpJobs() {
        GlobalScope.launch(Dispatchers.IO) {
            ...
            if(temp != null) {
                ...
                Log.e("Job", myJobs.size.toString())
...
//                Toast.makeText(view?.context, "No Job Found...", Toast.LENGTH_SHORT).show()
    ...
    companion object {
         ...
         * @return A new instance of fragment BookmarkedJobFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BookmarkedJobFragment().apply {
