...
class BookmarkedInternshipAdapter(val context: Context, val listener: JobItemClicked, val itemId: Int, val userId: String): RecyclerView.Adapter<BookmarkedInternshipAdapter.JobViewHolder>() {
    ...
    override fun onBindViewHolder(holder: JobViewHolder, position: Int) {
        ...
        holder.jobStatus.isVisible = false
