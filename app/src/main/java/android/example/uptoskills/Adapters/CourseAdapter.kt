...
class CourseAdapter(val context: Context,val listner: CourseItemClicked, val itemId: Int): RecyclerView.Adapter<CourseAdapter.CourseViewholder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CourseViewholder {
        var courseViewHolder = CourseViewholder(LayoutInflater.from(parent.context).inflate(itemId, parent, false))
